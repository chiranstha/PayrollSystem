    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
           ...
           //         new AppMenuItem('InternalGradeSetup', 'Pages.InternalGradeSetup', 'flaticon-more', '/app/main/payroll/internalGradeSetup'),
                    new AppMenuItem('School Infos', 'Pages.SchoolInfos', 'flaticon-more', '/app/main/payroll/schoolInfos'),
        ...
        //    new AppMenuItem('EmployeeSalary', 'Pages.EmployeeSalary', 'flaticon-more', '/app/main/payroll/employeeSalary'),
            new AppMenuItem('Generate Employee Salary', 'Pages.EmployeeSalary', 'flaticon-more', '/app/main/payroll/generateEmployeeSalary'),
            new AppMenuItem('Festival Bonus Settings', 'Pages.FestivalBonusSettings', 'flaticon-more', '/app/main/payroll/festivalBonusSettings'),
            new AppMenuItem('Grade Upgrades', 'Pages.GradeUpgrades', 'flaticon-more', '/app/main/payroll/gradeUpgrades'),
