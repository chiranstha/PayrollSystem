...
@NgModule({
    providers: [
        ...
        ApiServiceProxies.GradeUpgradesServiceProxy,        
        ApiServiceProxies.FestivalBonusSettingsServiceProxy,        
        ApiServiceProxies.PrincipalAllowanceSettingsServiceProxy,        
        ApiServiceProxies.EmployeeSalaryServiceProxy,        
        ApiServiceProxies.EmployeesServiceProxy,        
        ApiServiceProxies.FinancialYearsServiceProxy,        
        ApiServiceProxies.SchoolInfosServiceProxy,        
        ApiServiceProxies.InternalGradeSetupServiceProxy,        
        ApiServiceProxies.CategorySalaryServiceProxy,        
        ApiServiceProxies.EmployeeLevelsServiceProxy,        
        ...
        ApiServiceProxies.SchoolLevelServiceProxy,
        ApiServiceProxies.OrganizationUnitServiceProxy,
        ApiServiceProxies.PermissionServiceProxy,
        ApiServiceProxies.ProfileServiceProxy,
        ApiServiceProxies.RoleServiceProxy,
        ApiServiceProxies.SessionServiceProxy,
        ApiServiceProxies.MonthlyAllowanceServiceProxy,
