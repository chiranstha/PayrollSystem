...
using Suktas.Payroll.UiCustomization;
...
{
    public class SessionAppService : PayrollAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = PayrollConsts.Currency,
                        CurrencySign = PayrollConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = PayrollConsts.AllowTenantsToChangeEmailSettings,
