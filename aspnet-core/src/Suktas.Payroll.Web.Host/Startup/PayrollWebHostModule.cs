...
using Suktas.Payroll.Web.Startup.ExternalLoginInfoProviders;
...
namespace Suktas.Payroll.Web.Startup
{
    ...
    public class PayrollWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PayrollWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PayrollWebHostModule).GetAssembly());
        }
