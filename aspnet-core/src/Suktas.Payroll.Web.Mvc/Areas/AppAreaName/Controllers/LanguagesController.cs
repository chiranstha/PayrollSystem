...
using Suktas.Payroll.Web.Areas.AppAreaName.Models.Languages;
...
namespace Suktas.Payroll.Web.Areas.AppAreaName.Controllers
{
    ...
    public class LanguagesController : PayrollControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = PayrollConsts.LocalizationSourceName;
            }
