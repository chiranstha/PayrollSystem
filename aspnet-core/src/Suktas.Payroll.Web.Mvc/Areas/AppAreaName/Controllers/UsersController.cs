...
using Suktas.Payroll.Web.Areas.AppAreaName.Models.Roles;
using Suktas.Payroll.Web.Areas.AppAreaName.Models.Users;
...
namespace Suktas.Payroll.Web.Areas.AppAreaName.Controllers
{
    [Area("AppAreaName")]
    [AbpMvcAuthorize]
    public class UsersController : PayrollControllerBase
    {
