...
namespace Suktas.Payroll.Web.Areas.AppAreaName.Views.Shared.Themes.Theme6.Components.AppAreaNameTheme6Footer
{
    public class AppAreaNameTheme6FooterViewComponent : PayrollViewComponent
    {
