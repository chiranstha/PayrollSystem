...
namespace Suktas.Payroll.Web.Areas.AppAreaName.Views.Shared.Themes.Theme9.Components.AppAreaNameTheme9Footer
{
    public class AppAreaNameTheme9FooterViewComponent : PayrollViewComponent
    {
