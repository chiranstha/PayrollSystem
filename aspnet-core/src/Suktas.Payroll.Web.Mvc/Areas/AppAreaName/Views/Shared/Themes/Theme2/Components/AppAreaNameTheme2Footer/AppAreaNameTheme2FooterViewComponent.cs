...
namespace Suktas.Payroll.Web.Areas.AppAreaName.Views.Shared.Themes.Theme2.Components.AppAreaNameTheme2Footer
{
    public class AppAreaNameTheme2FooterViewComponent : PayrollViewComponent
    {
