...
namespace Suktas.Payroll.Web.Areas.AppAreaName.Views.Shared.Themes.Theme8.Components.AppAreaNameTheme8Footer
{
    public class AppAreaNameTheme8FooterViewComponent : PayrollViewComponent
    {
