...
namespace Suktas.Payroll.Web.TagHelpers
{
    ...
    public class PayrollPageSubheaderTagHelper : TagHelper
    {
        ...
        public PayrollPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
