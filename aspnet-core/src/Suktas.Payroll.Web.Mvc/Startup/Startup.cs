...
using Suktas.Payroll.Schemas;
using Suktas.Payroll.Web.Chat.SignalR;
using Suktas.Payroll.Web.Common;
using Suktas.Payroll.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using Suktas.Payroll.Web.Swagger;
using Stripe;
...
using Suktas.Payroll.Web.HealthCheck;
using Owl.reCAPTCHA;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using Suktas.Payroll.Web.Extensions;
using Suktas.Payroll.Web.MultiTenancy;
using SecurityStampValidatorCallback = Suktas.Payroll.Identity.SecurityStampValidatorCallback;
...
namespace Suktas.Payroll.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<PayrollWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UsePayrollForwardedHeaders();
            }
            else
            {
            ...
            if (PayrollConsts.PreventNotExistingTenantSubdomains)
            {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "Payroll API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Suktas.Payroll.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "Payroll API", Version = "v1"});
                ...
                var applicationXml = $"Suktas.Payroll.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"Suktas.Payroll.Web.Core.xml";
