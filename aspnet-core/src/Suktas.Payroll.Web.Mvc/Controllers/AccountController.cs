...
using Suktas.Payroll.Authentication.TwoFactor.Google;
...
using Suktas.Payroll.Authorization.Impersonation;
...
using Suktas.Payroll.Net.Sms;
using Suktas.Payroll.Notifications;
using Suktas.Payroll.Web.Models.Account;
using Suktas.Payroll.Security;
using Suktas.Payroll.Security.Recaptcha;
using Suktas.Payroll.Sessions;
using Suktas.Payroll.Url;
using Suktas.Payroll.Web.Authentication.External;
using Suktas.Payroll.Web.Security.Recaptcha;
using Suktas.Payroll.Web.Session;
using Suktas.Payroll.Web.Views.Shared.Components.TenantChange;
...
{
    public class AccountController : PayrollControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate =
                    Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(PayrollConsts.DateTimeOffsetFormat));
