...
{
    public class UserRepository : PayrollRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<PayrollDbContext> dbContextProvider)
