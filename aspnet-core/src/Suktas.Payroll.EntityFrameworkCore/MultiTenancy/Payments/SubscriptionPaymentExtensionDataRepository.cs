...
using Suktas.Payroll.EntityFrameworkCore.Repositories;

namespace Suktas.Payroll.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : PayrollRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<PayrollDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
