...
{
    public class SubscriptionPaymentRepository : PayrollRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<PayrollDbContext> dbContextProvider)
