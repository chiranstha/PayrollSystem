...
namespace Suktas.Payroll.Core.Base
{
    public abstract class PayrollQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected PayrollQueryBase(string fieldName,
