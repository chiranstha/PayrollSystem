...
using Suktas.Payroll.Web.Public.Startup;
using Suktas.Payroll.Web.Session;
using Suktas.Payroll.Web.UiCustomization;

namespace Suktas.Payroll.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : PayrollViewComponent
    {
