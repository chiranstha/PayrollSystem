...
namespace Suktas.Payroll.Web.Public.Startup
{
    ...
    public class PayrollWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public PayrollWebFrontEndModule(IWebHostEnvironment env, PayrollEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PayrollWebFrontEndModule).GetAssembly());
        }
    }
}
