...
using Suktas.Payroll.Mobile.MAUI.Services.Account;
using Suktas.Payroll.Mobile.MAUI.Services.UI;
using Microsoft.JSInterop;
using Suktas.Payroll.Mobile.MAUI.Services.Tenants;

#if ANDROID
using Suktas.Payroll.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace Suktas.Payroll.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new Suktas.Payroll.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
