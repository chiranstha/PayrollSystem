...
using Suktas.Payroll.Authorization.Ldap;
...
using Suktas.Payroll.DashboardCustomization.Definitions;
using Suktas.Payroll.Debugging;
using Suktas.Payroll.DynamicEntityProperties;
using Suktas.Payroll.Features;
...
using Suktas.Payroll.WebHooks;
using Newtonsoft.Json;

namespace Suktas.Payroll
{
    [DependsOn(
        typeof(PayrollCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class PayrollCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            PayrollLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = PayrollConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, PayrollMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<PayrollSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PayrollCoreModule).GetAssembly());
        }
