...
namespace Suktas.Payroll.Authorization.Users
{
    ...
    /// </summary>
    public class UserEmailer : PayrollServiceBase, IUserEmailer, ITransientDependency
    {
        ...
        public async Task SendPasswordResetLinkAsync(User user, string link = null)
        {
            ...
            if (!link.IsNullOrEmpty())
            {
                ...
                var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours).ToString(PayrollConsts.DateTimeOffsetFormat));
