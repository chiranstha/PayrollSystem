...
namespace Suktas.Payroll.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : PayrollServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Suktas.Payroll", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
