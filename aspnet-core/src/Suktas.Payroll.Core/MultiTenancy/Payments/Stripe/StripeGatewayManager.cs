...
{
    public class StripeGatewayManager : PayrollServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Payroll";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + PayrollConsts.Currency;
        }
