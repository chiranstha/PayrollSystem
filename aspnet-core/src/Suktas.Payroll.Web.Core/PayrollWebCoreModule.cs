...
using Suktas.Payroll.Authentication.TwoFactor;
...
using Suktas.Payroll.Web.Authentication.JwtBearer;
using Suktas.Payroll.Web.Authentication.TwoFactor;
using Suktas.Payroll.Web.Chat.SignalR;
using Suktas.Payroll.Web.Common;
using Suktas.Payroll.Web.Configuration;
...
namespace Suktas.Payroll.Web
{
    [DependsOn(
        typeof(PayrollApplicationModule),
        typeof(PayrollEntityFrameworkCoreModule),
    ...
    public class PayrollWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PayrollWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(PayrollApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PayrollWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(PayrollWebCoreModule).Assembly);
        }
