...
{
    public class PayrollAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public PayrollAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
