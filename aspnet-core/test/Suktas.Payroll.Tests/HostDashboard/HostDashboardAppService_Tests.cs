...
using Suktas.Payroll.MultiTenancy.HostDashboard;
...
namespace Suktas.Payroll.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(PayrollDbContext context, SubscriptionPayment subscriptionPayment)
        {
