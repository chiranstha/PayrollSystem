...
namespace Suktas.Payroll.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<PayrollDbContext>>()
            ...
            new PayrollDbContext(builder.Options).Database.EnsureCreated();
        }
